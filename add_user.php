...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Validate inputs
    if (empty($user_first_name) || empty($user_last_name) || empty($department_id) || empty($user_email_address) || empty($user_email_password) || empty($user_gender) || empty($user_status)) {
